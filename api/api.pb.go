...
func (*AddressPrKeyPairMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
func (c *walletClient) GenerateAddress(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*AddressPrKeyPairMessage, error) {
	...
	err := grpc.Invoke(ctx, "/protocol.Wallet/GenerateAddress", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletSolidityClient) GenerateAddress(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*AddressPrKeyPairMessage, error) {
	out := new(AddressPrKeyPairMessage)
	err := grpc.Invoke(ctx, "/protocol.WalletSolidity/GenerateAddress", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
